...
private let threads: [LabThread] = [
    .init(title: "Markdown rendering test", subtitle: "ras-code · Mac mini", time: "14h", initials: "MD", tint: .blue, preview: "Renderer stress test, terminal snippets, code blocks, and a very long markdown transcript."),
    ...
    .init(title: "Fix dark-mode header glass", subtitle: "ras-code/ipad-responsive-mobile-layout", time: "2h", initials: "DG", tint: .indigo, preview: "Compare dark scroll-edge material against Messages and Mail, then map the behavior back to React Native Screens."),
