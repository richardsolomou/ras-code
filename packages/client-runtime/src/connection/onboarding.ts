import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@ras-code/contracts";
import { resolveRemotePairingTarget } from "@ras-code/shared/remote";
...
>()("@ras-code/client-runtime/connection/onboarding/ConnectionOnboarding") {}
