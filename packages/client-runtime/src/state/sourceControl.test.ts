...
const PUBLISH_RESULT: SourceControlPublishRepositoryResult = {
  repository: {
    provider: "github",
    nameWithOwner: "t3tools/ras-code",
    url: "https://github.com/t3tools/ras-code",
    sshUrl: "git@github.com:t3tools/ras-code.git",
  },
  remoteName: "origin",
  remoteUrl: "git@github.com:t3tools/ras-code.git",
  branch: "main",
