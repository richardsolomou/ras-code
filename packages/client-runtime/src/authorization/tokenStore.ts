...
import { RelayManagedEndpoint } from "@ras-code/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@ras-code/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@ras-code/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
