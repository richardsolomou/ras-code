...
export const GRAPHITE_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    toolbarForeground: "oklch(0.210331 0.00586 285.885)",
    toolbarBorder: "oklch(0.919729 0.004031 286.32)",
    toolbarControl: "oklch(1 0 0)",
    toolbarControlForeground: "oklch(0.210331 0.00586 285.885)",
    toolbarControlHover: "oklch(0.943656 0.002669 286.349)",
    surface: "oklch(0.967434 0.001326 286.375)",
    surfaceRaised: "oklch(1 0 0)",
    surfaceOverlay: "oklch(1 0 0)",
    text: "oklch(0.210331 0.00586 285.885)",
    textMuted: "oklch(0.513024 0.012497 285.951)",
    border: "oklch(0.919729 0.004031 286.32)",
    input: "oklch(1 0 0)",
    focus: "oklch(0.210331 0.00586 285.885)",
    accent: "oklch(0.210331 0.00586 285.885)",
    accentForeground: "oklch(1 0 0)",
    secondary: "oklch(0.967434 0.001326 286.375)",
    secondaryForeground: "oklch(0.210331 0.00586 285.885)",
    muted: "oklch(0.967434 0.001326 286.375)",
    mutedForeground: "oklch(0.513024 0.012497 285.951)",
    placeholder: "oklch(0.544755 0.013852 285.931)",
    secondaryLabel: "oklch(0.441861 0.014617 285.786)",
    iconMuted: "oklch(0.711815 0.012937 286.067)",
    error: "oklch(0.577099 0.215157 27.325)",
    errorForeground: "oklch(0.50542 0.190493 27.518)",
    errorSurface: "oklch(0.935641 0.030896 17.717)",
    warning: "oklch(0.555283 0.145505 48.998)",
    warningForeground: "oklch(0.473189 0.124699 46.201)",
    warningSurface: "oklch(0.961896 0.058027 95.617)",
    update: "oklch(0.54615 0.215208 262.881)",
    updateForeground: "oklch(0.488198 0.217165 264.376)",
    updateSurface: "oklch(0.931918 0.031591 255.585)",
    accentSurface: "oklch(0.919729 0.004031 286.32)",
    accentSurfaceForeground: "oklch(0.210331 0.00586 285.885)",
    messageSurface: "oklch(0.967434 0.001326 286.375)",
    messageForeground: "oklch(0.210331 0.00586 285.885)",
    messageAction: "oklch(0.210331 0.00586 285.885)",
    messageActionForeground: "oklch(1 0 0)",
    messageActionHover: "oklch(0.370323 0.01188 285.805)",
    codeBackground: "oklch(0.967434 0.001326 286.375)",
    codeForeground: "oklch(0.210331 0.00586 285.885)",
    sidebar: "oklch(0.967434 0.001326 286.375)",
    sidebarForeground: "oklch(0.210331 0.00586 285.885)",
    sidebarMutedForeground: "oklch(0.513024 0.012497 285.951)",
    sidebarControlSurface: "oklch(1 0 0)",
    sidebarRowHover: "oklch(0.934594 0.002676 286.348)",
    sidebarRowActive: "oklch(0.919729 0.004031 286.32)",
    sidebarRowSelected: "oklch(0.904514 0.004048 286.319)",
    sidebarBorder: "oklch(0.919729 0.004031 286.32)",
    terminalBackground: "oklch(1 0 0)",
    terminalForeground: "oklch(0.210331 0.00586 285.885)",
    terminalCursor: "oklch(0.210331 0.00586 285.885)",
    terminalSelection: "oklch(0.871108 0.005451 286.286)",
    terminalScrollbar: "oklch(0.871108 0.005451 286.286)",
    terminalScrollbarHover: "oklch(0.711815 0.012937 286.067)",
  },
  variants: {
    dark: {
      canvas: "oklch(0.182204 0 0)",
      chrome: "oklch(0.182204 0 0)",
      toolbar: "oklch(0.182204 0 0)",
      toolbarForeground: "oklch(0.946105 0 0)",
      toolbarBorder: "oklch(0.268618 0 0)",
      toolbarControl: "oklch(0.22645 0 0)",
      toolbarControlForeground: "oklch(0.946105 0 0)",
      toolbarControlHover: "oklch(0.285017 0 0)",
      surface: "oklch(0.209036 0 0)",
      surfaceRaised: "oklch(0.239292 0 0)",
      surfaceOverlay: "oklch(0.260325 0 0)",
      text: "oklch(0.946105 0 0)",
      textMuted: "oklch(0.686223 0 0)",
      border: "oklch(0.285017 0 0)",
      input: "oklch(0.22645 0 0)",
      focus: "oklch(0.946105 0 0)",
      accent: "oklch(0.946105 0 0)",
      accentForeground: "oklch(0.182204 0 0)",
      secondary: "oklch(0.260325 0 0)",
      secondaryForeground: "oklch(0.946105 0 0)",
      muted: "oklch(0.239292 0 0)",
      mutedForeground: "oklch(0.686223 0 0)",
      placeholder: "oklch(0.633429 0 0)",
      secondaryLabel: "oklch(0.766755 0 0)",
      iconMuted: "oklch(0.541706 0 0)",
      error: "oklch(0.710627 0.166148 22.216)",
      errorForeground: "oklch(0.710627 0.166148 22.216)",
      errorSurface: "oklch(0.265509 0.052155 21.192)",
      warning: "oklch(0.836861 0.164422 84.429)",
      warningForeground: "oklch(0.836861 0.164422 84.429)",
      warningSurface: "oklch(0.311452 0.047245 86.918)",
      update: "oklch(0.71374 0.143381 254.624)",
      updateForeground: "oklch(0.71374 0.143381 254.624)",
      updateSurface: "oklch(0.268205 0.051725 259.018)",
      accentSurface: "oklch(0.285017 0 0)",
      accentSurfaceForeground: "oklch(0.946105 0 0)",
      messageSurface: "oklch(0.239292 0 0)",
      messageForeground: "oklch(0.946105 0 0)",
      messageAction: "oklch(0.946105 0 0)",
      messageActionForeground: "oklch(0.182204 0 0)",
      messageActionHover: "oklch(0.869944 0 0)",
      codeBackground: "oklch(0.209036 0 0)",
      codeForeground: "oklch(0.946105 0 0)",
      sidebar: "oklch(0.15434 0 0)",
      sidebarForeground: "oklch(0.946105 0 0)",
      sidebarMutedForeground: "oklch(0.686223 0 0)",
      sidebarControlSurface: "oklch(0.22645 0 0)",
      sidebarRowHover: "oklch(0.22645 0 0)",
      sidebarRowActive: "oklch(0.260325 0 0)",
      sidebarRowSelected: "oklch(0.285017 0 0)",
      sidebarBorder: "oklch(0.268618 0 0)",
      terminalBackground: "oklch(0.15434 0 0)",
      terminalForeground: "oklch(0.946105 0 0)",
      terminalCursor: "oklch(0.946105 0 0)",
      terminalSelection: "oklch(0.321093 0 0)",
      terminalScrollbar: "oklch(0.34846 0 0)",
      terminalScrollbarHover: "oklch(0.420237 0 0)",
    },
  },
  sidebarArtwork: true,
};
