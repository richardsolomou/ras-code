...
describe("resolveThreadReferenceCopyTarget", () => {
  it("prefers a durable linked pull request", () => {
    expect(
      resolveThreadReferenceCopyTarget({
        threadId: "thread-1",
        linkedPullRequestUrl: "https://github.com/ras-code/pr/12",
        detectedPullRequestUrl: "https://github.com/ras-code/pr/13",
      }),
    ).toMatchObject({
      kind: "pull-request",
      value: "https://github.com/ras-code/pr/12",
  ...
  it("uses a pull request detected from the active branch", () => {
    expect(
      ...
      kind: "pull-request",
      value: "https://github.com/ras-code/pr/13",
    });
  });
