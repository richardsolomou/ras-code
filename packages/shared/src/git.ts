...
export const WORKTREE_BRANCH_PREFIX = "ras-code";
/** Prefix generated before the rebrand; still on branches in existing checkouts. */
export const LEGACY_WORKTREE_BRANCH_PREFIX = "t3code";
export const WORKTREE_BRANCH_PREFIXES = [
  WORKTREE_BRANCH_PREFIX,
  LEGACY_WORKTREE_BRANCH_PREFIX,
] as const;
// Canonical form is `ras-code/<8 hex>`. Older mobile builds generated `<prefix>/<uuid>`
