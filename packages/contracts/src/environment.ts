...
/** What update path a client should offer for a server: one of the RPC
    ...
    version belongs to the RAS Code desktop app supervising it — updating the
...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server can fork after an assistant response. Missing means only legacy boundaries. */
  threadForkAfterMessage: Schema.optionalKey(Schema.Boolean),
