...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set RAS_CODE_BITBUCKET_EMAIL and RAS_CODE_BITBUCKET_API_TOKEN, or RAS_CODE_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check RAS_CODE_BITBUCKET_EMAIL and RAS_CODE_BITBUCKET_API_TOKEN.",
  },
};
