...
export const CUSTOM_THEMES_STORAGE_KEY = "ras-code:themes:v1";
export const THEME_FOLLOW_SYSTEM_STORAGE_KEY = "ras-code:theme-follow-system";
export const THEME_APPEARANCE_MODE_STORAGE_KEY = "ras-code:theme-appearance-mode";
export const THEME_HALVES_STORAGE_KEY = "ras-code:theme-halves:v1";

const LEGACY_DEFAULT_THEME_ID = "t3-chat";
const LEGACY_DARK_DEFAULT_THEME_ID = "t3-chat-dark";
...
export function canonicalThemePreference(theme: string): string {
  return theme === LEGACY_DARK_DEFAULT_THEME_ID ? theme : normalizeThemeId(theme);
}
...
// Older builds stored the dark RAS Code palette as a separate theme. Keep
...
function legacyThemeMode(theme: ThemePreference): ThemeAppearance | null {
  return theme === LEGACY_DARK_DEFAULT_THEME_ID ? "dark" : null;
}

/**
 * The palette RAS Code wears with no theme installed, captured from the app's
 ...
 */
const RAS_CODE_LIGHT_THEME_COLORS: ThemeColors = {
  canvas: "#fcfcfc",
  chrome: "#fcfcfc",
  toolbar: "#fcfcfc",
  ...
  update: "#2a2733",
  updateForeground: "#2a2733",
  updateSurface: "#e3e3e4",
  ...
  terminalSelection: "#d1d6de",
  terminalScrollbar: "#d9d9d9",
  terminalScrollbarHover: "#bfbfbf",
};

const RAS_CODE_DARK_THEME_COLORS: ThemeColors = {
  canvas: "#16141c",
  chrome: "#16141c",
  toolbar: "#16141c",
  toolbarForeground: "#e6e2ee",
  toolbarBorder: "#24222a",
  toolbarControl: "#1c1a24",
  toolbarControlForeground: "#e6e2ee",
  toolbarControlHover: "#1f1d25",
  surface: "#1f1c26",
  surfaceRaised: "#1f1d25",
  surfaceOverlay: "#1c1a24",
  text: "#e6e2ee",
  textMuted: "#9b96a9",
  border: "#24222a",
  input: "#29272e",
  focus: "#f0c24b",
  accent: "#f0c24b",
  accentForeground: "#100f15",
  secondary: "#1f1d25",
  secondaryForeground: "#f5f5f5",
  muted: "#1f1d25",
  mutedForeground: "#9b96a9",
  placeholder: "#9b96a9",
  secondaryLabel: "#9b96a9",
  iconMuted: "#9b96a9",
  error: "#e5645a",
  errorForeground: "#e5645a",
  errorSurface: "#372126",
  warning: "#fe9a00",
  warningForeground: "#f0c24b",
  warningSurface: "#3b2918",
  update: "#f0c24b",
  updateForeground: "#51a2ff",
  updateSurface: "#3d3324",
  accentSurface: "#1f1d25",
  accentSurfaceForeground: "#f5f5f5",
  messageSurface: "#1f1d25",
  messageForeground: "#e6e2ee",
  messageAction: "#f0c24b",
  messageActionForeground: "#100f15",
  messageActionHover: "#dab146",
  codeBackground: "#1e1b25",
  codeForeground: "#e6e2ee",
  sidebar: "#100f15",
  sidebarForeground: "#e6e2ee",
  sidebarMutedForeground: "#9b96a9",
  sidebarControlSurface: "#1c1a24",
  sidebarRowHover: "#212026",
  sidebarRowActive: "#28262d",
  sidebarRowSelected: "#1f1e24",
  sidebarBorder: "#232228",
  terminalBackground: "#16141c",
  terminalForeground: "#e6e2ee",
  terminalCursor: "#b4cbff",
  terminalSelection: "#3e4255",
  terminalScrollbar: "#3a3646",
  terminalScrollbarHover: "#4a4658",
};

/**
 * The standard RAS Code look as a theme palette, for seeding a new theme when
 * no theme is installed. Distinct from {@link getDefaultThemeColors}, which
 * carries the flagship RAS Code palette used to fill roles omitted by theme
 * files.
 */
export function getStandardThemeColors(appearance: ThemeAppearance): ThemeColors {
  if (appearance === "dark") {
    return (standardDarkThemeColors ??= decodeThemeColors(RAS_CODE_DARK_THEME_COLORS));
  }
  return (standardLightThemeColors ??= decodeThemeColors(RAS_CODE_LIGHT_THEME_COLORS));
}
...
/**
 * The status colors RAS Code shows without a theme, read from the app's own
