...
const RAS_CODE_DARK_THEME_COLORS: ThemeColors = {
  ...
  chrome: "#151515",
  toolbar: "#151515",
  toolbarForeground: "#e4e4e4",
  toolbarBorder: "#232323",
  toolbarControl: "#1c1c1c",
  toolbarControlForeground: "#e4e4e4",
  toolbarControlHover: "#1e1e1e",
  surface: "#1e1e1e",
  ...
  accentSurface: "#1e1e1e",
  accentSurfaceForeground: "#f5f5f5",
  messageSurface: "#1e1e1e",
  messageForeground: "#e4e4e4",
  messageAction: "#f0c24b",
  messageActionForeground: "#101010",
  messageActionHover: "#dab146",
  codeBackground: "#1d1d1d",
  codeForeground: "#e4e4e4",
  sidebar: "#101010",
  sidebarForeground: "#e4e4e4",
  sidebarMutedForeground: "#999999",
  sidebarControlSurface: "#1c1c1c",
  sidebarRowHover: "#212121",
  sidebarRowActive: "#272727",
  sidebarRowSelected: "#1f1f1f",
  sidebarBorder: "#232323",
  terminalBackground: "#151515",
  terminalForeground: "#e4e4e4",
  terminalCursor: "#b4cbff",
  terminalSelection: "#434343",
  terminalScrollbar: "#393939",
  terminalScrollbarHover: "#494949",
};
