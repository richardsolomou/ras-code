...
export const PERSISTED_STATE_KEY = "ras-code:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "ras-code:renderer-state:v8",
  "ras-code:renderer-state:v7",
  "ras-code:renderer-state:v6",
  "ras-code:renderer-state:v5",
  "ras-code:renderer-state:v4",
  "ras-code:renderer-state:v3",
