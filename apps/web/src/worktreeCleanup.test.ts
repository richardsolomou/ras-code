...
describe("formatWorktreePathForDisplay", () => {
  it("shows only the last path segment for unix-like paths", () => {
    const result = formatWorktreePathForDisplay(
      "/Users/julius/.ras-code/worktrees/ras-code-mvp/ras-code-4e609bb8",
    );
    expect(result).toBe("ras-code-4e609bb8");
  });

  it("normalizes windows separators before selecting the final segment", () => {
    const result = formatWorktreePathForDisplay(
      "C:\\Users\\julius\\.ras-code\\worktrees\\ras-code-mvp\\ras-code-4e609bb8",
    );
    expect(result).toBe("ras-code-4e609bb8");
  });

  it("uses the final segment even when outside ~/.ras-code/worktrees", () => {
