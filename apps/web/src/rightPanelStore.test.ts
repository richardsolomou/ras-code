...
describe("rightPanelStore", () => {
  ...
  it("tracks one surface per pull request", () => {
    const first = { projectId: "project-a", repository: "richardsolomou/ras-code", number: 4909 };
    const second = { projectId: "project-a", repository: "richardsolomou/ras-code", number: 4910 };
