...
const PIERRE_ICON_SPRITE_ID = "ras-code-pierre-file-icon-sprite";

const RAS_CODE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <!-- Lucide Film icon, ISC license. -->
  <symbol id="ras-code-file-icon-video" viewBox="0 0 24 24">
  ...
  <symbol id="ras-code-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="ras-code-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="ras-code-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="ras-code-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="ras-code-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="ras-code-file-icon-pnpm" viewBox="0 0 32 32">
...
export const RAS_CODE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: RAS_CODE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "ras-code-file-icon-package-json",
    "tsconfig.json": "ras-code-file-icon-tsconfig",
    "agents.md": "ras-code-file-icon-agents",
    "claude.md": "ras-code-file-icon-claude",
    "readme.md": "ras-code-file-icon-readme",
    "pnpm-lock.yaml": "ras-code-file-icon-pnpm",
    "pnpm-workspace.yaml": "ras-code-file-icon-pnpm",
  },
  byFileExtension: Object.fromEntries(
    VIDEO_FILE_EXTENSIONS.map((extension) => [extension, "ras-code-file-icon-video"]),
  ),
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(RAS_CODE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${RAS_CODE_FILE_ICON_SPRITE}`;
