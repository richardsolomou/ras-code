...
/**
 * Accounts that opted out of the post-sign-in RAS Connect onboarding wizard
 * ("Don't show this again"). The wizard otherwise shows on every sign-in,
 * since sign-out clears the connected environments.
 */
export const CONNECT_ONBOARDING_OPT_OUT_STORAGE_KEY = "ras-code:connect-onboarding-opt-out:v1";
