...
import type { AssistantCitation, MessageId, ScopedThreadRef } from "@ras-code/contracts";
...
const COMMENT_HIGHLIGHT_NAME = "ras-code-assistant-citation-comment";
...
export function observeAssistantCitationSource({
  ...
  const clear = () => {
    if (highlighted && CSS.highlights.get("ras-code-assistant-citation") === highlighted) {
      CSS.highlights.delete("ras-code-assistant-citation");
    }
    highlighted = null;
    ownedRange = null;
  ...
  const highlight = () => {
    ...
    if (typeof Highlight !== "undefined" && typeof CSS !== "undefined" && CSS.highlights) {
      ...
      CSS.highlights.set("ras-code-assistant-citation", highlighted);
      ownedRange = range;
    ...
    if (!pulseAnimation) {
      ...
      pulseAnimation.id = "ras-code-assistant-citation-pulse";
