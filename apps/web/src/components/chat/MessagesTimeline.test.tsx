...
describe("MessagesTimeline", () => {
  ...
  it("renders unsafe user HTML as inert source text", async () => {
    ...
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        ...
        timelineEntries={[
          buildUserTimelineEntry(
            '<script>globalThis.__rasCodeXss = 1</script><img src="x" onerror="globalThis.__rasCodeXss = 2">',
          ),
        ]}
      />,
    );

    expect(markup).toContain("&lt;script&gt;globalThis.__rasCodeXss = 1&lt;/script&gt;");
    expect(markup).toContain(
      "&lt;img src=&quot;x&quot; onerror=&quot;globalThis.__rasCodeXss = 2&quot;&gt;",
    );
  ...
  it("sanitizes executable HTML while preserving supported assistant markup", async () => {
      ...
      <MessagesTimeline
        ...
        timelineEntries={[
          buildAssistantTimelineEntry(
            [
              '<details open onclick="globalThis.__rasCodeXss = 1">',
              "<summary>Safe details</summary>",
              "<script>globalThis.__rasCodeXss = 2</script>",
              '<img src="x" onerror="globalThis.__rasCodeXss = 3">',
              '<a href="javascript:globalThis.__rasCodeXss = 4">Unsafe link</a>',
              "</details>",
            ].join(""),
          ),
        ]}
    ...
    expect(markup).not.toContain("globalThis.__rasCodeXss");
  });
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/ras-code/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/ras-code"
      />,
    );

    expect(markup).toContain("Changed 1 file");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/ras-code/apps/web/src/session-logic.ts");
  });
