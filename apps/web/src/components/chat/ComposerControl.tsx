...
const composerControlClassName =
  "legend console-cap rounded-[6px] text-secondary-label transition-none hover:bg-[var(--accent)] hover:text-foreground [&_svg[data-composer-control-chevron]]:-mx-0.5 [&_svg[data-composer-control-icon]]:mx-0";
