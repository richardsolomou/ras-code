...
const NO_FILE_SCRIPTS: ReadonlyArray<RasProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in ras.json, offered for import. */
  fileScripts?: ReadonlyArray<RasProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: RasProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From ras.json</MenuGroupLabel>
