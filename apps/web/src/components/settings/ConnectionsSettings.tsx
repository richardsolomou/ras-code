  ...
  return (
    <>
      ...
      <SettingsRow
        ...
        description="Send activity to mobile notifications and Live Activities without RAS Connect."
        control={
          <CloudLinkSwitch
    ...
    return (
      <>
        ...
        {desktopWslState.enabled ? (
          <SettingsRow
            title="WSL only"
            description="Run only the WSL backend. RAS Code restarts when this changes."
