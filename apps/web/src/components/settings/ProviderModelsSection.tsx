...
import { normalizeCustomModelSlug } from "@ras-code/shared/model";
...
/** Normalizes providers' boolean and service-tier fast modes to the composer's labels. */
...
/** Keeps favorites, visible models, and hidden models in separate reorderable groups. */
...
export function ProviderModelsSection({
  ...
  const handleAdd = () => {
    ...
    // The new row must render before its pending scroll target can resolve.
  ...
  const renderRow = (model: DisplayModel) => {
    ...
    // Favorites and visibility are independent preferences.
    ...
    // Reordering a filtered view would be ambiguous.
    const canMoveUp =
    ...
    return (
      ...
      >
        ...
        {/* Preserve the grid column while hiding its text on narrow screens. */}
