import { DEFAULT_CLIENT_SETTINGS } from "@ras-code/contracts";
...
describe("clientPersistenceStorage", () => {
  ...
  it("reports structured decode failures while preserving the fallback", async () => {
    ...
    testWindow.localStorage.setItem("ras-code:client-settings:v1", "not-json");
    ...
    expect(consoleError).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        operation: "decode",
        storageKey: "ras-code:client-settings:v1",
