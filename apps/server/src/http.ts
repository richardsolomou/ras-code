...
import { isDevProxiedPath } from "@ras-code/shared/devProxy";
import { decodeOtlpTraceRecords } from "@ras-code/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["ras-code://app", "ras-code-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // RAS_CODE_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
