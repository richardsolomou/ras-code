...
const BaseTestLayer = makeProjectionPipelinePrefixedTestLayer("ras-code-projection-pipeline-test-");

it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("ras-code-projection-cursor-batch-")))(
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("ras-code-projection-attachments-safe-")),
...
it.layer(
  Layer.fresh(
    makeProjectionPipelinePrefixedTestLayer("ras-code-projection-attachments-overwrite-"),
  ),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("ras-code-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("ras-code-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("ras-code-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("ras-code-projection-attachments-replay-")),
)("OrchestrationProjectionPipeline", (it) => {
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "ras-code-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "ras-code-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
