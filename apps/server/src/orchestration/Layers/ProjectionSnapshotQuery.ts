...
const ProjectionThreadDbRowSchema = ProjectionThread.mapFields(
  Struct.assign({
    ...
    forkedFrom: Schema.NullOr(Schema.fromJsonString(ThreadForkPoint)),
  }),
);
    ...
    execute: () =>
      sql`
        SELECT
          ...
          settled_reason AS "settledReason",
            ...
            Effect.gen(function* () {
              ...
              for (const row of messageRows) {
                ...
                threadMessages.push({
                  ...
                  ...(row.inherited === 1 ? { inherited: true } : {}),
                  createdAt: row.createdAt,
                  updatedAt: row.updatedAt,
                });
              ...
              threads: Arr.filterMap(threadRows, (row) =>
                row.deletedAt === null
                  ? Result.succeed({
                      ...
                      lastFallbackEngagedAt: row.lastFallbackEngagedAt ?? null,
                      latestAssistantSummary: row.latestAssistantSummary ?? null,
            ...
            : repositoryIdentityResolver.resolve(option.value.workspaceRoot).pipe(
                Effect.map((repositoryIdentity) =>
                  Option.some({
                    ...
                    iconEmoji: option.value.iconEmoji ?? null,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        settledReason: threadRow.value.settledReason,
        ...
        lastFallbackEngagedAt: threadRow.value.lastFallbackEngagedAt ?? null,
        latestAssistantSummary: threadRow.value.latestAssistantSummary ?? null,
        backgroundLiveness: threadBackgroundLiveness.getThreadBackgroundLiveness(
