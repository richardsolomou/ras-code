...
it("launch prompt stays a single argv-safe line naming the prompt file", () => {
  ...
  const launch = buildTriageLaunchPrompt(
    String.raw`C:\Users\a b\.ras-code\userdata\triage\x\prompt.md`,
  );
  assert.notInclude(launch, "\n");
  assert.include(launch, String.raw`C:\Users\a b\.ras-code\userdata\triage\x\prompt.md`);
...
it("context file carries every path the playbook depends on", () => {
  const context = buildTriageContext({
    ...
    os: "linux x64 (7.0.0)",
    nodeVersion: "v24.0.0",
    launchedAs: "npx ras-code triage",
    server: "running (pid 42, http://127.0.0.1:4501)",
    paths: {
      stateDir: "/home/u/.ras-code/userdata",
      dbPath: "/home/u/.ras-code/userdata/state.sqlite",
      settingsPath: "/home/u/.ras-code/userdata/settings.json",
      logsDir: "/home/u/.ras-code/userdata/logs",
      serverLogPath: "/home/u/.ras-code/userdata/logs/server.log",
      serverTracePath: "/home/u/.ras-code/userdata/logs/server.trace.ndjson",
      providerEventLogPath: "/home/u/.ras-code/userdata/logs/provider/events.log",
      terminalLogsDir: "/home/u/.ras-code/userdata/logs/terminals",
      providerStatusCacheDir: "/home/u/.ras-code/caches",
      secretsDir: "/home/u/.ras-code/userdata/secrets",
      sourceCacheDir: "/home/u/.ras-code/source",
    },
  });
  assert.include(context, "/home/u/.ras-code/userdata/state.sqlite");
  assert.include(context, "/home/u/.ras-code/userdata/logs/server.trace.ndjson");
  assert.include(context, "/home/u/.ras-code/userdata/logs/provider/events.log");
  assert.include(context, "/home/u/.ras-code/userdata/secrets");
  assert.include(context, "/home/u/.ras-code/source");
  assert.include(context, "npx ras-code triage");
