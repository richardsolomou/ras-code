/**
 * `ras triage` - hand a misbehaving install to the user's own coding agent.
 *
...
export const triageCommand = Command.make("triage", {
  ...
  Command.withDescription(
    "Investigate a RAS Code problem on this machine with claude or codex, and help file a good issue.",
  ),
  Command.withHandler((flags) =>
    Effect.gen(function* () {
      ...
      // --base-dir wins; RAS_CODE_HOME is its documented env equivalent (same
      // precedence as `ras pair`).
