import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@ras-code/contracts";
...
import { KeybindingsConfigError } from "@ras-code/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "ras-code-keybindings-test-",
        }),
      ),
    ),
  );
