...
describe("Antigravity process environment", () => {
  const profile: AntigravityProfile = {
    platform: "linux",
    geminiHome: "/ras-code/userdata/providers/antigravity/profile",
    acpDirectory: "/ras-code/userdata/providers/antigravity/profile/antigravity-acp",
    tokenPath: "/ras-code/userdata/providers/antigravity/profile/antigravity-acp/acp_token.json",
