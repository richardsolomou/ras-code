import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@ras-code/contracts";
...
import { normalizeModelSlug } from "@ras-code/shared/model";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: RAS_CODE_OAUTH_REFERRER,
    },
  };
}
