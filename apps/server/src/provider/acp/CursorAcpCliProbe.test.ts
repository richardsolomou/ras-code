 ...
 * Enable with: RAS_CURSOR_ACP_PROBE=1 bun run test --filter CursorAcpCliProbe
 */
...
describe.runIf(process.env.RAS_CURSOR_ACP_PROBE === "1")("Cursor ACP CLI probe", () => {
    ...
    Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "ras-code-probe", version: "0.0.0" },
