...
import type { RelayLinkProofRequest } from "@ras-code/contracts/relay";
import { consumeCloudReplayGuards, linkProofScopes, reconcileDesiredCloudLink } from "./http.ts";
...
describe("link proof provider kinds", () => {
  ...
  it("only claims the managed-relay scope for relay links", () => {
    expect(linkProofScopes(proofRequest("ras_relay"))).toEqual([
