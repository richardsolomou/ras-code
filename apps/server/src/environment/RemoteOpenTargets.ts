 ...
 */
import { type RemoteOpenTarget } from "@ras-code/contracts";
import { HostProcessHostname } from "@ras-code/shared/hostProcess";
import * as NetService from "@ras-code/shared/Net";
import { readTailscaleStatus } from "@ras-code/tailscale";
...
>()("ras-code/environment/RemoteOpenTargets") {}
