...
import { SourceControlProviderError, type ChangeRequest } from "@ras-code/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set RAS_CODE_BITBUCKET_EMAIL and RAS_CODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
