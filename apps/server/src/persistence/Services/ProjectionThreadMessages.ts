...
export const ProjectionThreadMessage = Schema.Struct({
  ...
  // Copied from a parent thread at fork time. See OrchestrationMessage.inherited.
...
>()("ras-code/persistence/Services/ProjectionThreadMessages/ProjectionThreadMessageRepository") {}
