...
public final class RasCodeTerminalView: ExpoView, UITextFieldDelegate {
  ...
  var terminalKey: String = "" {
    didSet {
      accessibilityIdentifier = "ras-code-terminal-\(terminalKey)"
  ...
  private func setupWriteCallback() {
    ...
    ghostty_surface_set_write_callback(surface, { userdata, data, len in
      ...
      let view = Unmanaged<RasCodeTerminalView>.fromOpaque(userdata).takeUnretainedValue()
  ...
  private func writeThemeConfigFile() -> String? {
    ...
    let url = URL(fileURLWithPath: NSTemporaryDirectory())
      .appendingPathComponent("ras-code-terminal-theme-\(appearance.rawValue).ghostty")
