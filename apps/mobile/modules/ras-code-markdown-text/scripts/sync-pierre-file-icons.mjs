...
const customSprite = webIconSource.match(/const RAS_CODE_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error(
    "Could not read the RAS Code Pierre icon sprite from apps/web/src/pierre-icons.ts",
  );
}
...
const customIcons = {
  agents: "ras-code-file-icon-agents",
  claude: "ras-code-file-icon-claude",
  package: "ras-code-file-icon-package-json",
