...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "ras-code-composer-paste"
...
public final class RasCodeComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
  ...
  private var fontFamily = "Barlow-Regular"
  ...
  private func renderChip(
    ...
    let font = UIFont(name: "Barlow-Medium", size: max(12, fontSize - 2))
