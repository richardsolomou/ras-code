...
import type { ChatFileAttachment, EnvironmentId } from "@ras-code/contracts";
...
function VideoPlayback(props: { readonly file: AttachmentPreviewFile }) {
  ...
  return (
    <>
      ...
      >
        <AppText className="font-ras-code-medium text-base text-white">
    ...
    >
      ...
      >
        <View className="min-h-14 flex-row items-center gap-3 pl-4 pr-2">
          <AppText className="flex-1 font-ras-code-medium text-base text-white" numberOfLines={2}>
            {attachment.name}
          </AppText>
          <Pressable
            accessibilityRole="button"
