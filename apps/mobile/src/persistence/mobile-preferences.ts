...
const PREFERENCES_KEY = "ras-code.preferences";
const PREFERENCES_FALLBACK_KEY = "ras-code.preferences.fallback";
...
>()("@ras-code/mobile/persistence/MobilePreferencesStore") {}
