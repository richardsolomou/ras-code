...
const CONNECTIONS_KEY = "ras-code.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "ras-code.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "ras-code.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "ras-code.recent-thread-shortcuts";
