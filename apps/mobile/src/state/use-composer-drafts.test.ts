...
describe("mobile composer drafts", () => {
  ...
  it("releases videos rejected by the live draft limit and keeps accepted files", async () => {
    ...
    const makeAttachment = (id: string) => ({
      ...
      sizeBytes: 42,
      fileUri: `file:///documents/ras-code-composer-attachments/${id}.mov`,
    });
  ...
  it("keeps shared attachment files until every draft releases them", async () => {
    ...
    const file = {
      ...
      mimeType: "application/pdf",
      sizeBytes: 42,
      fileUri: "file:///documents/ras-code-composer-attachments/report.pdf",
    };
    appAtomRegistry.set(composerDraftsAtom, {
  ...
  it("retains a referenced file-backed image and releases it once unreferenced", async () => {
    ...
    const image = {
      ...
      mimeType: "image/png",
      sizeBytes: 3,
      fileUri: "file:///documents/ras-code-composer-attachments/photo.png",
      previewUri: "file:///documents/ras-code-composer-attachments/photo.png",
    };
    appAtomRegistry.set(composerDraftsAtom, {
  ...
  it("keeps a failed-send draft's pending upload for retry", async () => {
    ...
    const file = {
      ...
      mimeType: "application/pdf",
      sizeBytes: 42,
      fileUri: "file:///documents/ras-code-composer-attachments/failed-send.pdf",
  ...
  it.each(["file", "image"] as const)(
    ...
    async (type) => {
      ...
      const metadata = {
        ...
        sizeBytes: 42,
        fileUri: `file:///documents/ras-code-composer-attachments/${name}`,
        uploadEnvironmentId: environmentId,
  ...
  it.each(["file", "image"] as const)(
    ...
    async (type) => {
      ...
      const metadata = {
        ...
        sizeBytes: 42,
        fileUri: `file:///private/var/mobile/Containers/Data/Application/11111111-1111-4111-8111-111111111111/Documents/ras-code-composer-attachments/${fileName}`,
      };
      const file =
        type === "image"
          ? { ...metadata, type, previewUri: metadata.fileUri }
      ...
      const currentFile = {
        ...file,
        fileUri: `file:///var/mobile/Containers/Data/Application/22222222-2222-4222-8222-222222222222/Documents/ras-code-composer-attachments/${fileName}`,
      };
  ...
  it("preserves a preview opened while cleanup is checking the incoming inbox", async () => {
    ...
    const file = {
      ...
      mimeType: "video/mp4",
      sizeBytes: 42,
      fileUri: "file:///documents/ras-code-composer-attachments/recording.mp4",
    };
  ...
  it("removes an unreferenced local file and its pending upload", async () => {
    ...
    const file = {
      ...
      mimeType: "application/pdf",
      sizeBytes: 42,
      fileUri: "file:///documents/ras-code-composer-attachments/discarded.pdf",
  ...
  it("keeps a pending upload referenced through another local file", async () => {
    ...
    const discarded = {
      ...
      mimeType: "application/pdf",
      sizeBytes: 42,
      fileUri: "file:///documents/ras-code-composer-attachments/discarded-copy.pdf",
    ...
    const retained = {
      ...
      fileUri: "file:///documents/ras-code-composer-attachments/retained-copy.pdf",
    };
    appAtomRegistry.set(composerDraftsAtom, {
  ...
  it("completes local cleanup when pending upload deletion fails", async () => {
    ...
    const file = {
      ...
      mimeType: "application/pdf",
      sizeBytes: 42,
      fileUri: "file:///documents/ras-code-composer-attachments/delete-failed.pdf",
  ...
  it("keeps a file until its incoming share is consumed", async () => {
    ...
    const file = {
      ...
      mimeType: "application/pdf",
      sizeBytes: 42,
      fileUri: "file:///documents/ras-code-composer-attachments/incoming.pdf",
    };
  ...
  it("does not delete files when incoming share ownership cannot be loaded", async () => {
    ...
    const file = {
      ...
      mimeType: "application/pdf",
      sizeBytes: 42,
      fileUri: "file:///documents/ras-code-composer-attachments/incoming-unknown.pdf",
    };
    const warning = vi.spyOn(console, "warn").mockImplementation(() => undefined);
  ...
  it("takes out only what the merge inserted when the user edited during it", () => {
    ...
    const keptAttachment = {
      ...
      mimeType: "application/pdf",
      sizeBytes: 1,
      fileUri: "file:///documents/ras-code-composer-attachments/kept.pdf",
    };
    const insertedAttachment = {
      ...
      mimeType: "application/pdf",
      sizeBytes: 1,
      fileUri: "file:///documents/ras-code-composer-attachments/inserted.pdf",
    };
  ...
  it("spares a file re-owned between the sweep's scan and its deletion", async () => {
    ...
    const fileFor = (id: string) => ({
      ...
      mimeType: "application/pdf",
      sizeBytes: 42,
      fileUri: `file:///documents/ras-code-composer-attachments/${id}.pdf`,
    });
