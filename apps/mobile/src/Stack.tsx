...
import { SettingsUpdateTrackRouteScreen } from "./features/settings/SettingsUpdateTrackRouteScreen";
...
const SettingsContentStack = createNativeStackNavigator({
  ...
  screens: {
    ...
    SettingsUpdateTrack: createNativeStackScreen({
      screen: SettingsUpdateTrackRouteScreen,
      linking: "update-track",
      options: {
        title: "Update Track",
      },
    }),
...
function RootStackLayout(props: {
  ...
  // Presents the RAS Connect onboarding sheet after an in-session sign-in.
...
function NotFoundScreen() {
  ...
  return (
    ...
    >
      <Text className="text-3xl font-ras-code-bold text-foreground" selectable>
        Route not found
      </Text>
      <Pressable
      ...
      >
        <Text className="text-base font-ras-code-bold text-primary-foreground">Return home</Text>
      </Pressable>
    </ScrollView>
  );
}
