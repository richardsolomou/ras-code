  ...
  return (
    <View className="flex-1 items-center justify-center bg-screen px-10">
      <View className="max-w-[360px] items-center gap-3">
        ...
        <Text className="text-center text-xl font-ras-code-bold">Select a thread</Text>
        ...
        {props.onStartNewTask ? (
          ...
          >
            <Text className="text-base font-ras-code-bold text-primary-foreground">New Task</Text>
          </Pressable>
        ) : null}
      </View>
    </View>
