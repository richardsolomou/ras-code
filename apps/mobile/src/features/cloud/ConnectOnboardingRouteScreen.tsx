...
import { reportAtomCommandResult, settlePromise } from "@ras-code/client-runtime/state/runtime";
...
/**
 * Post-sign-in onboarding sheet for RAS Connect. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's RAS Connect environments right after sign-in so every
        ...
        {isSignedIn ? (
          ...
          <View collapsable={false} className="rounded-[24px] bg-card p-5">
            <Text className="text-sm leading-normal text-foreground-muted">
              Sign in to your RAS Code account to set up RAS Connect.
            </Text>
          </View>
        )}
