...
// than text-sm at every supported base font size, so row height is
...
export function collapsedWorkLogHeight(activities: ReadonlyArray<ThreadFeedActivity>): number {
  ...
  return WORK_LOG_BOTTOM_MARGIN + rowsHeight + (rows.length - 1) * WORK_ROW_GAP;
}
                    ...
                    <>
                      ...
                      <Text
                        className={cn(
                          ...
                          iconIsDestructive &&
                            "font-ras-code-medium text-rose-600 dark:text-rose-400",
                        )}
