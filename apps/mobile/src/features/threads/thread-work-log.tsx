...
import type { EnvironmentId, ToolActivityIcon } from "@ras-code/contracts";
...
import { resolveWorkGroupScrollAnchor } from "@ras-code/client-runtime/work-log/scroll-anchor";
...
type WorkContentIcon = AppSymbolName | "browser" | "ras-code";
...
function workLogRowHeight(row: ThreadFeedActivity, rowHeight: number): number {
  return row.maxLines === 2 ? rowHeight * 2 : rowHeight;
}
...
function workLogRowsHeight(
  ...
  return (
    activities.reduce((total, row) => total + workLogRowHeight(row, rowHeight), 0) +
            ...
            <>
              ...
              <Text
                className={cn(
                  ...
                  iconIsDestructive && "font-ras-code-medium text-rose-600 dark:text-rose-400",
                )}
...
export function ThreadWorkGroupToggle(props: {
  ...
  readonly themeAppearance: "light" | "dark";
  readonly toolSurface?: import("@ras-code/contracts").ToolActivitySurface;
  readonly toolIcon?: ToolActivityIcon;
