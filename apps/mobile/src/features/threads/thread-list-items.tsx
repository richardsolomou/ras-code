    ...
    >
      ...
      >
        ...
        <Text
          className={
            compact
              ? "flex-shrink text-base font-ras-code-bold tracking-[0.2px] text-foreground-muted"
              : "flex-shrink text-sm font-ras-code-bold tracking-[0.2px] text-foreground-muted"
          }
          numberOfLines={1}
        >
          {props.title}
        ...
        <Text
          className={
            compact
              ? "flex-1 text-sm font-ras-code-medium text-foreground-tertiary"
              : "flex-1 text-xs font-ras-code-medium text-foreground-tertiary"
          }
        >
          {props.threadCount}
        </Text>
    ...
    >
      <View className="flex-row items-center gap-1.5">
        ...
        <Text
          className={
            compact
              ? "text-sm font-ras-code-medium text-foreground-muted"
              : "text-xs font-ras-code-medium text-foreground-muted"
          }
        >
          {label}
        </Text>
...
export const PendingTaskListRow = memo(function PendingTaskListRow(props: {
  ...
  const statusPill = (
    <View className="rounded-full bg-zinc-500/12 px-1.5 py-0.5 dark:bg-zinc-500/16">
      <Text className="text-3xs font-ras-code-bold text-zinc-600 dark:text-zinc-300">Pending</Text>
    </View>
  );
  ...
  const rowContent = compact ? (
      ...
      >
        ...
        >
          <View className="flex-row items-center justify-between gap-2">
            <Text className="flex-1 text-lg font-ras-code-bold text-foreground" numberOfLines={1}>
              {pendingTask.title}
            </Text>
    ...
    >
      <View className="gap-[3px]">
        <View className="flex-row items-center justify-between gap-2">
          <Text className="flex-1 text-base font-ras-code-medium text-foreground" numberOfLines={1}>
            {pendingTask.title}
          </Text>
          <View className="flex-row items-center gap-2">
            {statusPill}
      ...
      <View className="mt-px flex-row items-center gap-1.5">
        ...
        {pr !== null ? (
          <View className="flex-row items-center gap-0.5">
            ...
            />
            <Text
              className={`${compact ? "text-sm" : "text-xs"} font-ras-code-medium ${
      ...
      >
        <View className="gap-[3px]">
          <View className="flex-row items-center justify-between gap-2">
            <Text
              className={cn(
                "flex-1 text-base font-ras-code-medium",
