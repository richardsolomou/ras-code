import { type KnownTerminalSession } from "@ras-code/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@ras-code/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@ras-code/shared/terminalLabels";
