...
import { RasCodeKeyboardCommands } from "../../native/RasCodeKeyboardCommands";
...
export function HardwareKeyboardCommandProvider({
  ...
  return (
    <>
      <RasCodeKeyboardCommands enabledCommands={enabledCommands} onCommand={onCommand}>
        {children}
      </RasCodeKeyboardCommands>
