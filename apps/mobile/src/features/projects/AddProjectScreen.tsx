...
import { CommandId, type EnvironmentId, ProjectId } from "@ras-code/contracts";
    ...
    >
      <View className="flex-row items-center gap-3">
        ...
        <View className="flex-1 gap-0.5">
          <Text className="text-base leading-snug font-ras-code-bold">{props.title}</Text>
          {props.subtitle ? (
  ...
  return (
    ...
    >
      {props.loading ? (
        ...
        <Text className="text-base font-ras-code-bold text-primary-foreground">{props.label}</Text>
      )}
    </Pressable>
  );
}
...
function EmptyEnvironmentState() {
  ...
  return (
    <View className="items-center gap-3 rounded-2xl bg-card px-5 py-8">
      <Text className="text-center text-lg font-ras-code-bold">Environment unavailable</Text>
      ...
      >
        <Text className="text-sm font-ras-code-bold text-primary-foreground">Add environment</Text>
      </Pressable>
    </View>
  );
}
    ...
    <AddProjectShell>
      ...
      {repositoryTitle ? (
        <View className="rounded-[24px] bg-card px-4 py-3">
          <Text className="text-base font-ras-code-bold">{repositoryTitle}</Text>
