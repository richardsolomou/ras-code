...
function getGnomeKeyringRemediationMessage(): string {
  return "RAS Code could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart RAS Code.";
}

function getKWalletRemediationMessage(): string {
  return "RAS Code could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart RAS Code.";
}
