...
const OVERLAY_ATTRIBUTE = "data-ras-code-annotation-ui";
const Z_INDEX_OVERLAY = 2147483646;
const PRIMARY = "var(--ras-code-primary)";
const PRIMARY_FILL = "color-mix(in srgb, var(--ras-code-primary) 10%, transparent)";
...
const applyAnnotationTheme = (
  ...
  const variables = {
    "--ras-code-radius": theme.radius,
    "--ras-code-background": theme.background,
    "--ras-code-foreground": theme.foreground,
    "--ras-code-popover": theme.popover,
    "--ras-code-popover-foreground": theme.popoverForeground,
    "--ras-code-primary": theme.primary,
    "--ras-code-primary-foreground": theme.primaryForeground,
    "--ras-code-muted": theme.muted,
    "--ras-code-muted-foreground": theme.mutedForeground,
    "--ras-code-accent": theme.accent,
    "--ras-code-accent-foreground": theme.accentForeground,
    "--ras-code-border": theme.border,
    "--ras-code-input": theme.input,
    "--ras-code-ring": theme.ring,
    "--ras-code-font-sans": theme.fontSans,
    "--ras-code-font-mono": theme.fontMono,
  };
...
function startAnnotation(): void {
  ...
  cursorStyle.textContent = `html[data-ras-code-annotation-tool] body, html[data-ras-code-annotation-tool] body * { cursor: crosshair !important; } [${OVERLAY_ATTRIBUTE}], [${OVERLAY_ATTRIBUTE}] * { cursor: default !important; } [${OVERLAY_ATTRIBUTE}] input[type=number]::-webkit-inner-spin-button, [${OVERLAY_ATTRIBUTE}] input[type=number]::-webkit-outer-spin-button { appearance:none; margin:0; }`;
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-ras-code-annotation-tool", tool);
  };
      ...
      if (isUsableRect(rect)) {
        ...
        if (found === 0) {
          ...
          const regionBox = createBox(
            PRIMARY,
            "color-mix(in srgb, var(--ras-code-primary) 6%, transparent)",
          );
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-ras-code-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
