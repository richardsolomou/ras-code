import { bootstrapRemoteBearerSession } from "@ras-code/client-runtime/authorization";
...
>()("@ras-code/desktop/backend/DesktopLocalEnvironmentAuth") {}
