...
// oxlint-disable-next-line ras-code/no-global-process-runtime -- Standalone repair script has no Effect runtime.
...
function installElectronRuntime(electronDir, version) {
  const tempDir = NodeFS.mkdtempSync(NodePath.join(NodeOS.tmpdir(), "ras-code-electron-"));
