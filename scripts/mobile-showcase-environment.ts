...
const PROJECT_FAVICONS = {
  ...
  <rect width="128" height="128" rx="10" fill="#16141C"/>
  ...
  <rect x="79" y="7" width="18" height="18" rx="3" fill="#2A2733" fill-opacity="0.28" />
  <rect x="31" y="31" width="18" height="18" rx="3" fill="#F0C24B" />
  <rect x="34" y="34" width="12" height="12" rx="2" fill="#FFE08A" fill-opacity="0.5" />
  <rect x="55" y="31" width="18" height="18" rx="3" fill="#2A2733" fill-opacity="0.28" />
  ...
  <rect x="79" y="55" width="18" height="18" rx="3" fill="#2A2733" fill-opacity="0.28" />
  <rect x="31" y="79" width="18" height="18" rx="3" fill="#F0C24B" />
  <rect x="34" y="82" width="12" height="12" rx="2" fill="#FFE08A" fill-opacity="0.5" />
  <rect x="55" y="79" width="18" height="18" rx="3" fill="#2A2733" fill-opacity="0.28" />
  ...
  <rect x="55" y="103" width="18" height="18" rx="3" fill="#2A2733" fill-opacity="0.28" />
