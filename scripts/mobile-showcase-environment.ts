// @effect-diagnostics nodeBuiltinImport:off globalTimers:off globalDate:off - This host-side fixture creates an isolated local RAS Code environment.
...
export const SHOWCASE_PROJECT_ID = "ras-code";
...
const SHOWCASE_TERMINAL_PROMPT =
  "\u001b[1;32m→\u001b[0m \u001b[1;36mras-code\u001b[0m \u001b[1;34mgit:(\u001b[1;31mfeat/remote-command-center\u001b[1;34m)\u001b[0m \u001b[1;33m✗\u001b[0m ";
...
export const SHOWCASE_TERMINAL_BUFFER = [
  ...
  "  \u001b[32m→\u001b[0m  \u001b[2mProject:\u001b[0m  \u001b[1mras-code\u001b[0m \u001b[2m— ~/Code/ras-code\u001b[0m",
  "",
...
const PROJECT_FAVICONS = {
  ...
  <rect width="128" height="128" rx="10" fill="#1F1C26"/>
  ...
  <rect x="79" y="7" width="18" height="18" rx="3" fill="#2E2A38" fill-opacity="0.28" />
  <rect x="31" y="31" width="18" height="18" rx="3" fill="#F0C24B" />
  <rect x="34" y="34" width="12" height="12" rx="2" fill="#FFE08A" fill-opacity="0.5" />
  <rect x="55" y="31" width="18" height="18" rx="3" fill="#2E2A38" fill-opacity="0.28" />
  ...
  <rect x="79" y="55" width="18" height="18" rx="3" fill="#2E2A38" fill-opacity="0.28" />
  <rect x="31" y="79" width="18" height="18" rx="3" fill="#F0C24B" />
  <rect x="34" y="82" width="12" height="12" rx="2" fill="#FFE08A" fill-opacity="0.5" />
  <rect x="55" y="79" width="18" height="18" rx="3" fill="#2E2A38" fill-opacity="0.28" />
  ...
  <rect x="55" y="103" width="18" height="18" rx="3" fill="#2E2A38" fill-opacity="0.28" />
...
export const SHOWCASE_PROJECTS = [
  {
    ...
    title: "RAS Code",
    directory: "ras-code",
    repositoryUrl: "https://github.com/richardsolomou/ras-code.git",
    favicon: PROJECT_FAVICONS.rasCode,
  },
  {
    id: "react",
    title: "React",
...
async function seedRasCodeWorkspace(workspaceRoot: string): Promise<void> {
  ...
  await NodeFSP.writeFile(
    ...
    `${JSON.stringify({ name: "ras-code", private: true, scripts: { test: "vp test" } }, null, 2)}\n`,
  );
  await NodeFSP.writeFile(NodePath.join(workspaceRoot, "favicon.svg"), PROJECT_FAVICONS.rasCode);
  await NodeFSP.writeFile(
...
async function seedCompanionWorkspace(input: {
  ...
  await NodeFSP.writeFile(
    ...
    `# ${input.title}\n\nSeeded by the RAS Code mobile screenshot harness.\n`,
  );
  await initializeRepository({
...
export async function seedShowcaseEnvironment(input: {
  ...
  if (primaryProject.id === SHOWCASE_PROJECT_ID) {
    await seedRasCodeWorkspace(workspaceRoot);
  }
  await Promise.all(
    projects
