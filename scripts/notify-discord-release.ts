  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new RAS Code prerelease is available for nightly testers."
          : "A new RAS Code latest release is available.",
...
).pipe(Command.withDescription("Post a RAS Code release announcement to Discord."));
