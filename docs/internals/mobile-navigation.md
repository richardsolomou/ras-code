...
iOS delegates full-screen video to [AVKit](../../apps/mobile/modules/ras-code-native-controls/ios/RasCodeNativeVideoPresentation.swift)
and images and documents to [Quick Look](../../apps/mobile/modules/ras-code-native-controls/ios/RasCodeNativeFilePresentation.swift).
...
[Thumbnail registration](../../apps/mobile/modules/ras-code-native-controls/ios/RasCodeNativePresentation.swift)
