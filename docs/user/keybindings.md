...
The same configuration lives in `~/.ras-code/userdata/keybindings.json` on the machine running the
server, if you prefer editing it directly. RAS Code writes the built-in defaults into that file on
