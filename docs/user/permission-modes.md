...
Antigravity uses its own permission policy for each mode. RAS Code still shows any approval or
...
RAS Code's separate Plan mode control is not available for Antigravity. See
