import type { RelayDeviceRegistrationRequest } from "@ras-code/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.richardsolomou.ras-code.preview" as RelayDeviceRegistrationRequest["bundleId"],
    ...
    return Effect.gen(function* () {
      ...
      expect(insertedValues).toEqual([
        expect.objectContaining({
          userId: "user-2",
          deviceId: "device-1",
          bundleId: "com.richardsolomou.ras-code.preview",
          apsEnvironment: "production",
