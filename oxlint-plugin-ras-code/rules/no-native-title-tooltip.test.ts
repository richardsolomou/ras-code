...
const rule = createOxlintRuleHarness("ras-code/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("ras-code/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · RAS Code";`);
