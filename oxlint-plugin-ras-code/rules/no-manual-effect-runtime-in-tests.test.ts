...
const rule = createOxlintRuleHarness("ras-code/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("ras-code/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("ras-code/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("ras-code/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("ras-code/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
